...
(defun get-question () "прога задает вопрос по заданной теме"
       (interactive)
...
(global-set-key (kbd "s-9") 'get-question)

(defun set-response () "прога считывает ответ игрока"
       (interactive)
       (lake-fire)
...
(global-set-key (kbd "s-0") 'set-response)
